                            ...
                            <TableHead>
                                <TableRow sx={{}}>
                                    ...
                                    <TableCell sx={{ py: 1.1, display: 'flex', justifyContent: 'flex-end' }} colSpan={0}>
                                        ...
                                        >
                                            <Box sx={{width:{sm:'500px',xs:'auto'}}} height={'auto'} >
                                                <Box px={7} py={7} >
            ...
            <Box sx={{ backgroundColor: '#F9FAFB' }}>
                ...
                <Grid container>
                    ...
                    <Grid sm={10} xs={12} height={'100vh'} position={'relative'}>
                        ...
                        <DownNav ComponentName={<Box
                            sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                            <Link to="/team" style={{ textDecoration: 'none', color: '#000' }} ><Typography>Team</Typography></Link>
                            <ArrowForwardIosSharpIcon fontSize="small" sx={{ color: '#00778B' }} />
