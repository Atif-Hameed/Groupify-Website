...
import { Avatar, Box, Button, Checkbox, Dialog, DialogContent, DialogContentText, DialogTitle, Grid, Menu, MenuItem, Typography, styled } from "@mui/material";
                ...
                <Table stickyHeader aria-label="sticky table">
                        ...
                        <TableRow>
                            ...
                            <TableCell sx={{ py: 1.1, display: 'flex', justifyContent: 'flex-end' }} colSpan={0}>
                                <Link style={{ textDecoration: 'none' }}>
                                    <Box onClick={e => { setdialogOpen(true) }} gap={1} sx={{ color: '#00778B', display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                                ...
                                <Dialog
                                    ...
                                    <DialogContent sx={{ width: '100%', p: 0, m: 0 }}>
                                        <NewPost des={<Avatar onClick={e => setdialogOpen(false)} sx={{ backgroundColor: '#fff', cursor:'pointer' }}>
                    ...
                    <TableBody sx={{ backgroundColor: '#F6F6F6' }}>
                        ...
                        <TableRow >
                            ...
                            <TableCell sx={{ pr: 4, py: 1 }}>
                                <Button variant="contained" sx={{ py: 0, px: 3, backgroundColor: '#EBEBEB', color: '#6B7280', fontSize: '12px', textTransform: 'lowercase' }} disableElevation>draft</Button>
                            </TableCell>
